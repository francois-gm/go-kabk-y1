...
#### 1) Peer reviews (60min)

- You will have to collectively review twelve (10) other student's projects (!) For this we will use EtherPad, which allows to collaboratively (and anonymously) edit text in real time. 
